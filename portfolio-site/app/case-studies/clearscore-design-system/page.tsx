...
export function Intro() {
  return (
    <p className={csStyles.intro}>Leading a multi-displinary team to rebuild a multi-platform, multi-brand Design System from the ground up.</p>
  )
}
...
export function Role() {
  return (
    <div className={csStyles.role}>
      <p><span>My role:</span> Lead Designer and Product Owner</p>
    </div>
  )
}
